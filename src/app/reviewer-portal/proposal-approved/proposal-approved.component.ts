...
@Component({
  selector: 'app-proposal-approved',
  templateUrl: './proposal-approved.component.html',
  styleUrls: ['./proposal-approved.component.css']
})
export class ProposalApprovedComponent implements OnInit {
  authState;
  files;
  proposalsArray;
